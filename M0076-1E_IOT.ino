...
#define AIO_USERNAME    "M0076"
#define AIO_KEY         "aio_OIcA80NBGQkeCQvzNveq639zRhEX"
...
Adafruit_MQTT_Publish hb1 = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/supply_voltage");
Adafruit_MQTT_Publish spo21 = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/supply_current");
Adafruit_MQTT_Publish temp1 = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/unit");
...
void loop() {
  ...
  while ((subscription = mqtt.readSubscription(5000))) {
    ...
    if (strcmp((char *)mode0.lastread, "3") == 0) {
